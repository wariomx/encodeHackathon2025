...
class Compiler {
    ...
    async loadWorkerHandler() {
        ...
        if (typeof (window) !== 'undefined' && Worker) {
            const ESWebWorker = await Promise.resolve().then(() => tslib_1.__importStar(require('../lib/es-web-worker/es-web-worker-handler')));
    ...
    internalCompile(files, missingInputs, timeStamp) {
        if (timeStamp < this.state.compilationStartTime && this.state.compilerRetriggerMode == types_1.CompilerRetriggerMode.retrigger) {
            return;
        }
                    ...
                    try {
                        if (source && source.sources) {
                            ...
                            if (useFileConfiguration) {
                                ...
                                input = (0, compiler_input_1.default)(source.sources, { optimize, runs, evmVersion, language, remappings });
                            }
            ...
            if (source && source.sources) {
                ...
                try {
                    if (useFileConfiguration) {
                        ...
                        if (compilerInput.settings.remappings?.length)
                            compilerInput.settings.remappings.push(...remappings);
                        else
                            compilerInput.settings.remappings = remappings;
                        input = (0, compiler_input_1.compilerInputForConfigFile)(source.sources, compilerInput);
                    }
                    else {
                        input = (0, compiler_input_1.default)(source.sources, { optimize, runs, evmVersion, language, remappings });
                    }
