...
async function precompile0d(opts) {
    ...
    if (inputData.length === 0) {
        ...
        return (0, evm_js_1.EvmErrorResult)(new exceptions_js_1.EvmError(exceptions_js_1.ERROR.BLS_12_381_INPUT_EMPTY), opts.gasLimit); // follow Geths implementation
    }
    ...
    const gasUsed = (0, index_js_1.msmGasUsed)(numPairs, gasUsedPerPair);
    if (!(0, index_js_1.gasCheck)(opts, gasUsed, 'BLS12G1MSM (0x0d)')) {
    ...
    if (!(0, index_js_1.moduloLengthCheck)(opts, 160, 'BLS12G1MSM (0x0d)')) {
        return (0, evm_js_1.EvmErrorResult)(new exceptions_js_1.EvmError(exceptions_js_1.ERROR.BLS_12_381_INVALID_INPUT_LENGTH), opts.gasLimit);
    }
    ...
    for (let k = 0; k < numPairs; k++) {
        ...
        if (!(0, index_js_1.leading16ZeroBytesCheck)(opts, zeroByteRanges, 'BLS12G1MSM (0x0d)', pairStart)) {
    ...
    if (opts._debug !== undefined) {
        opts._debug(`BLS12G1MSM (0x0d) return value=${(0, util_1.bytesToHex)(returnValue)}`);
    }
    return {
