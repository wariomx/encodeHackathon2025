...
function formatMemory(mem) {
    const hexMem = (0, util_1.bytesToHex)(mem).substr(2);
    const ret = [];
...
function sha3_256(value) {
    if ((value.constructor && value.constructor.name === 'BigNumber') || bn_js_1.BN.isBN(value) || (0, web3_validator_1.isBigInt)(value)) {
        value = value.toString(16);
    }
    if (typeof value === 'number') {
        value = value.toString(16);
    }
    value = (0, util_1.toBytes)((0, util_1.addHexPrefix)(value));
    const retInBuffer = remix_lib_1.hash.keccak(Buffer.from((0, util_1.setLengthLeft)(value, 32)));
    return (0, util_1.bytesToHex)(retInBuffer);
}
/**
