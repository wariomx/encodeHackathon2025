...
exports.BLS12_381_ToG2Point = exports.BLS12_381_ToG1Point = exports.BLS12_381_ToFrPoint = exports.BLS12_381_ToFpPoint = exports.BLS12_381_ToFp2Point = exports.BLS12_381_FromG2Point = exports.BLS12_381_FromG1Point = exports.MCLBLS = void 0;
...
function BLS12_381_ToG1Point(input, mcl, verifyOrder = true) {
    ...
    const p_x = (0, util_1.bytesToUnprefixedHex)(input.subarray(16, constants_js_1.BLS_G1_POINT_BYTE_LENGTH / 2));
    const p_y = (0, util_1.bytesToUnprefixedHex)(input.subarray(80, constants_js_1.BLS_G1_POINT_BYTE_LENGTH));
    const G1 = new mcl.G1();
...
function BLS12_381_FromG1Point(input) {
    ...
    if (decodeStr === '0') {
        return new Uint8Array(constants_js_1.BLS_G1_POINT_BYTE_LENGTH);
    }
...
function BLS12_381_FromG2Point(input) {
    ...
    if (decodeStr === '0') {
        return new Uint8Array(constants_js_1.BLS_G2_POINT_BYTE_LENGTH);
    }
    const decoded = decodeStr.match(/"?[0-9a-f]+"?/g); // match above pattern.
...
class MCLBLS {
    ...
    addG1(input) {
        ...
        const p1 = BLS12_381_ToG1Point(input.subarray(0, constants_js_1.BLS_G1_POINT_BYTE_LENGTH), this._mcl, false);
        const p2 = BLS12_381_ToG1Point(input.subarray(constants_js_1.BLS_G1_POINT_BYTE_LENGTH, constants_js_1.BLS_G1_POINT_BYTE_LENGTH * 2), this._mcl, false);
        const result = this._mcl.add(p1, p2);
        return BLS12_381_FromG1Point(result);
    }
    mulG1(input) {
        // convert input to G1 points, add them, and convert the output to a Uint8Array.
        const p = BLS12_381_ToG1Point(input.subarray(0, constants_js_1.BLS_G1_POINT_BYTE_LENGTH), this._mcl);
        const frPoint = BLS12_381_ToFrPoint(input.subarray(constants_js_1.BLS_G1_POINT_BYTE_LENGTH, 160), this._mcl);
        const result = this._mcl.mul(p, frPoint);
        return BLS12_381_FromG1Point(result);
    }
    addG2(input) {
        // convert input to G1 points, add them, and convert the output to a Uint8Array.
        const p1 = BLS12_381_ToG2Point(input.subarray(0, constants_js_1.BLS_G2_POINT_BYTE_LENGTH), this._mcl, false);
        const p2 = BLS12_381_ToG2Point(input.subarray(constants_js_1.BLS_G2_POINT_BYTE_LENGTH, constants_js_1.BLS_G2_POINT_BYTE_LENGTH * 2), this._mcl, false);
        const result = this._mcl.add(p1, p2);
        return BLS12_381_FromG2Point(result);
    }
    mulG2(input) {
        // convert input to G2 point/Fr point, add them, and convert the output to a Uint8Array.
        const p = BLS12_381_ToG2Point(input.subarray(0, constants_js_1.BLS_G2_POINT_BYTE_LENGTH), this._mcl);
        const frPoint = BLS12_381_ToFrPoint(input.subarray(constants_js_1.BLS_G2_POINT_BYTE_LENGTH, 288), this._mcl);
        const result = this._mcl.mul(p, frPoint);
        return BLS12_381_FromG2Point(result);
    }
    mapFPtoG1(input) {
    ...
    msmG1(input) {
        ...
        for (let k = 0; k < numPairs; k++) {
            ...
            const G1 = BLS12_381_ToG1Point(input.subarray(pairStart, pairStart + constants_js_1.BLS_G1_POINT_BYTE_LENGTH), this._mcl);
            const Fr = BLS12_381_ToFrPoint(input.subarray(pairStart + constants_js_1.BLS_G1_POINT_BYTE_LENGTH, pairStart + pairLength), this._mcl);
            G1Array.push(G1);
            FrArray.push(Fr);
        }
    ...
    msmG2(input) {
        ...
        for (let k = 0; k < numPairs; k++) {
            const pairStart = pairLength * k;
            const G2 = BLS12_381_ToG2Point(input.subarray(pairStart, pairStart + constants_js_1.BLS_G2_POINT_BYTE_LENGTH), this._mcl);
            const Fr = BLS12_381_ToFrPoint(input.subarray(pairStart + constants_js_1.BLS_G2_POINT_BYTE_LENGTH, pairStart + pairLength), this._mcl);
            G2Array.push(G2);
            FrArray.push(Fr);
        }
    ...
    pairingCheck(input) {
        ...
        for (let k = 0; k < input.length / pairLength; k++) {
            ...
            const G2 = BLS12_381_ToG2Point(input.subarray(g2start, g2start + constants_js_1.BLS_G2_POINT_BYTE_LENGTH), this._mcl);
            pairs.push([G1, G2]);
        }
