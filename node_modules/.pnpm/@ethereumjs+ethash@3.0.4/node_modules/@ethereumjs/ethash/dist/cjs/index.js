    ...
    async mine(iterations = 0) {
        ...
        if (solution) {
            if (this.block) {
                ...
                return block_1.Block.fromBlockData(data, { common: this.block.common });
            }
            else {
                const data = this.blockHeader.toJSON();
                data.mixHash = solution.mixHash;
                data.nonce = solution.nonce;
                return block_1.BlockHeader.fromHeaderData(data, { common: this.blockHeader.common });
            }
        }
    }
    /**
...
class Ethash {
    ...
    run(val, nonce, fullSize) {
        ...
        const s = (0, keccak_js_1.keccak512)((0, util_1.concatBytes)(val, (0, util_js_1.bytesReverse)(nonce)));
        ...
        for (i = 0; i < util_js_1.params.ACCESSES; i++) {
            ...
            mix = (0, util_js_1.fnvBytes)(mix, (0, util_1.concatBytes)(...newdata));
        }
