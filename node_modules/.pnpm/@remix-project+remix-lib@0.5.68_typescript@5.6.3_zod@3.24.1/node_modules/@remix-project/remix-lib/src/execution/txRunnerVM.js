    ...
    runInVm(tx, callback) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (signed) {
                    if (!EIP1559) {
                        tx = tx_1.LegacyTransaction.fromSerializedTx((0, util_1.hexToBytes)(data), { common: this.commonContext });
                    }
                    else {
                        tx = tx_1.FeeMarketEIP1559Transaction.fromSerializedTx((0, util_1.hexToBytes)(data), { common: this.commonContext });
                    }
                }
                else {
