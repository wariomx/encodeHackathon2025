...
async function precompile0c(opts) {
    ...
    if (!(0, index_js_1.gasCheck)(opts, gasUsed, 'BLS12G1MUL (0x0c)')) {
        return (0, evm_js_1.OOGResult)(opts.gasLimit);
    }
    if (!(0, index_js_1.equalityLengthCheck)(opts, 160, 'BLS12G1MUL (0x0c)')) {
    ...
    if (!(0, index_js_1.leading16ZeroBytesCheck)(opts, zeroByteRanges, 'BLS12G1MUL (0x0c)')) {
    ...
    if (opts._debug !== undefined) {
        opts._debug(`BLS12G1MUL (0x0c) return value=${(0, util_1.bytesToHex)(returnValue)}`);
    }
    return {
