...
import type { BlockchainEvents, BlockchainInterface, BlockchainOptions, Consensus, OnBlock } from './types.js';
...
export declare class Blockchain implements BlockchainInterface {
     ...
     */
    private _getHeader;
    checkAndTransitionHardForkByNumber(number: BigIntLike, td?: BigIntLike, timestamp?: BigIntLike): Promise<void>;
    /**
