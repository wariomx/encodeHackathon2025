...
function precompile05(opts) {
    ...
    if (opts._debug !== undefined) {
        opts._debug(`Run MODEXP (0x05) precompile data=${(0, util_1.short)(opts.data)} length=${opts.data.length} gasLimit=${opts.gasLimit} gasUsed=${gasUsed}`);
    }
    ...
    if (opts._debug !== undefined) {
        opts._debug(`MODEXP (0x05) return value=${(0, util_1.bytesToHex)(res)}`);
    }
    return {
        executionGasUsed: gasUsed,
        returnValue: res,
