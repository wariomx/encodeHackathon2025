...
async function precompile12(opts) {
    ...
    if (!(0, index_js_1.gasCheck)(opts, gasUsed, 'BLS12MAPFPTOG1 (0x12)')) {
        return (0, evm_js_1.OOGResult)(opts.gasLimit);
    }
    if (!(0, index_js_1.equalityLengthCheck)(opts, 64, 'BLS12MAPFPTOG1 (0x12)')) {
    ...
    if (!(0, index_js_1.leading16ZeroBytesCheck)(opts, zeroByteRanges, 'BLS12MAPFPTOG1 (0x12)')) {
    ...
    if (opts._debug !== undefined) {
        opts._debug(`BLS12MAPFPTOG1 (0x12) return value=${(0, util_1.bytesToHex)(returnValue)}`);
    }
    return {
