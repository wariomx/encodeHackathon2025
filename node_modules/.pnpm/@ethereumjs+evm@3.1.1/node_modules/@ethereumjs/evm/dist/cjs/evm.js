...
class EVM {
     ...
     * @returns A new EVM
     */
    static async create(createOpts) {
        const opts = createOpts ?? {};
        const bn128 = initializedRustBN ?? (await (0, rustbn_wasm_1.initRustBN)());
        initializedRustBN = bn128;
        if (opts.common === undefined) {
            opts.common = new common_1.Common({ chain: common_1.Chain.Mainnet });
        }
        if (opts.blockchain === undefined) {
            opts.blockchain = new types_js_1.DefaultBlockchain();
        }
        if (opts.stateManager === undefined) {
            opts.stateManager = new statemanager_1.DefaultStateManager();
        }
