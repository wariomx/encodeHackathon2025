...
class TxListener {
    constructor(opt, executionContext) {
        ...
        opt.event.udapp.register('callExecuted', (error, from, to, data, lookupOnly, txResult) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (this.executionContext.isVM()) {
                ...
                returnValue = (0, util_1.toBytes)(execResult.returnValue);
            }
            else {
                returnValue = (0, util_1.toBytes)((0, util_1.addHexPrefix)(txResult.result));
            }
            const call = {
                from: from,
                to: to,
        ...
        opt.event.udapp.register('transactionExecuted', (error, from, to, data, lookupOnly, txResult) => {
            ...
            if (this._loopId)
                return; // we seems to already listen on a "web3" network
            this.executionContext.web3().eth.getTransaction(txResult.transactionHash).then((tx) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                let execResult;
                if (this.executionContext.isVM()) {
                    execResult = yield this.executionContext.web3().remix.getExecutionResultFromSimulator(txResult.transactionHash);
                }
    ...
    _decodeInputParams(data, abi) {
        data = (0, util_1.toBytes)((0, util_1.addHexPrefix)(data));
        if (!data.length)
            data = new Uint8Array(32 * abi.inputs.length); // ensuring the data is at least filled by 0 cause `AbiCoder` throws if there's not enough data
        const inputTypes = [];
